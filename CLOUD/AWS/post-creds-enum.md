...
| command | IRL sample | comments | 
|-----:|---------------:|---------------|
|aws --profile XYZ iam list users| ![image](https://github.com/user-attachments/assets/f8038ce5-c25b-4851-a260-7e4a93fe3c3c) | generic true to any command - you can specify the --profile at the start or finish of command|   
